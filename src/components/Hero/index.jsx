...
const Hero = () => (
  <Section>
    ...
    <Description>
      ...
      Quick to learn and adept at working with the latest web technologies, such as React.JS, JavaScript, HTML5, CSS3, NodeJS, SASS, Figma, Svelte, Python, and more. <br></br>
